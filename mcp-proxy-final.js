...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  ...
  try {
    const response = await fetch('https://sol-research-mcp.fly.dev/mcp', {
      method: 'POST',
      headers: {
        'Authorization': 'Bearer sk_qb85RiisZTwwgMjNM14eyFM7wHQN0CbGLFjlLOvwAjrTQ4sq',
