...
exports.AdvancedNERDetector = exports.NERDetector = void 0;
const base_1 = require("./base");
class NERDetector extends base_1.BaseDetector {
    constructor() {
        super(...arguments);
        this.name = 'ner';
        this.version = '1.0.0';
...
class AdvancedNERDetector extends NERDetector {
    constructor() {
        super(...arguments);
        this.name = 'advanced-ner';
        this.version = '1.0.0';
    }
...
exports.AdvancedNERDetector = AdvancedNERDetector;
